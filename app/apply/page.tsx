  ...
  if (status === 'success') return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <br/>
        <p style={{ color: '#666', margin: 0 }}>Thank you for your interest in joining our company. We have successfully received your CV. Our talent acquisition team reviews every application on a rolling basis. If your experience aligns with our needs, we will reach out to discuss the next steps.</p>
      </div>
    </div>
  )
